///////////////  API   //////////////////////
//fetch("https://api.tvmaze.com/shows/id seryal/episodes").then((response) => {
//  return response.json();
//});
//mitonim bar asas id serial url bezarim to fetch va bad ke data fetch kardim response daryaft kon va on ro besorat json daryaft konim 
//1.fetch url bar asas seryal ya ravash me
//data gerftim
//option
//search addEventListener mizanim 
